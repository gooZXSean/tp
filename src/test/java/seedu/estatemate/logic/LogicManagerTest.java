...
import static seedu.estatemate.testutil.TypicalPersons.AMY;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonEstateMateStorage estateMateStorage =
                new JsonEstateMateStorage(temporaryFolder.resolve("estateMate.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(estateMateStorage, userPrefsStorage);
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an EstateMateStorage that throws the IOException e when saving
        JsonEstateMateStorage estateMateStorage = new JsonEstateMateStorage(prefPath) {
            @Override
            public void saveEstateMate(ReadOnlyEstateMate estateMate, Path filePath)
                    throws IOException {
                throw e;
            }
        };
