...
/**
 * Finds and lists all tenants in EstateMate whose name contains any of the argument keywords.
...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all tenants whose names contain any of "
